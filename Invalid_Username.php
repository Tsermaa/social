...
<div style="position:absolute;left:26%; top:25%; height:1; width:46.85%; background-color:#DD3C10; "> </div>
<div style="position:absolute;left:26%; top:25%; height:60%; width:0.10%; background-color:#DD3C10; "> </div>
<div style="position:absolute;left:26%; top:84.9%; height:1; width:46.85%; background-color:#DD3C10; "> </div>
<div style="position:absolute;left:72.75%; top:25%; height:60%; width:0.10%; background-color:#DD3C10; "> </div>

<div style="position:absolute; left:27.4%; top:28.2%;">  <font size="4"> ШУТИС-МХТС нэвтрэх </font>  </div>

<div style="position:absolute;left:27.4%; top:32.8%; height:1; width:44.05%; background-color:#DD3C10; "> </div>
...
<div style="position:absolute;left:27.4%; top:36.2%; height:1; width:44.05%; background-color:#DD3C10; "> </div>
	...
	<div style="position:absolute; left:28%; top:37.2%;"> <font size="4"> Нэвтрэх нэр буруу </font>  </div>
	<div style="position:absolute; left:28%; top:42.2%; font-size:12;">  Таны оруулсан нэвтрэх нэр бүртгэлгүй байна.  </div>
	<div style="position:absolute; left:28%; top:48.7%; font-size:12;">  Зөв байна.  </div>
	
<form  method="post">
	<div style="position:absolute; left:35.5%; top:57.2%; font-size:15; color:#333333;"> Нэвтрэх нэр: </div>
	<div style="position:absolute; left:43.5%; top:57%; font-size:11px; "> <input type="text" name="username" style="width:174;"/> </div>
	<div style="position:absolute; left:35.5%; top:62.2%; font-size:15; color:#333333;"> Нууц үг: </div>
