...
<div style="position:absolute;left:31.5%; top:54%; font-weight:bold; z-index:1;"> <a href="Profile.php" style="text-decoration:none; color:#FF1493;" onMouseOver="on_timeline_txt();" onMouseOut="out_timeline_txt();">  Timeline </a> </div>
...
<div style="position:absolute;left:44.7%; top:54%; font-weight:bold; z-index:1; color:#FF1493;"> <a href="photos.php" style="text-decoration:none; color:#FF1493;" onMouseOver="on_photos_txt();" onMouseOut="out_photos_txt();">  Photos </a> <samp style="color:#717171;"> <?php echo $photos_count; ?> </samp> </div>
