...
<body>
	...
	<div style="position:absolute; left:25%; top:18%; color:#3B59A4; font-size:24px;"> Нэр </div>
    ...
    <hr style="position:absolute;left:25%;top:25%;height:0.5%;width:50%; border-color:#EE82EE; box-shadow:0px 5px 5px 0px rgb(0,0,0); ">
    
    
    <div style="position:absolute; left:25%; top:35%; color:#3B59A4; font-size:24px;"> Нууц үг </div>
    ...
    <hr style="position:absolute;left:25%;top:42%;height:0.5%;width:50%; border-color:#EE82EE; box-shadow:0px 5px 5px 0px rgb(0,0,0); ">
...
<h1 style="color:#FFFFFF;"> Өөрчилсөн нэр </h1> </div>
...
<form method="post"  name="name_change"  onSubmit="return name_check();">
	<div style="position:fixed; left:35%; top:33%; z-index:4; font-size:18px;"> Овог </div>
    ...
    <div style="position:fixed; left:35%; top:40%; z-index:4; font-size:18px;"> Нэр </div>
...
<h1 style="color:#FFFFFF;"> Өөрчилсөн нууц үг </h1> </div>
...
<form method="post"  name="password_change"  onSubmit="return password_check()">
	<div style="position:fixed; left:33%; top:34%; z-index:4; font-size:18px;"> Өмнөх нууц үг </div>
    ...
    <div style="position:fixed; left:33%; top:41%; z-index:4; font-size:18px;"> Шинэ нууц үг </div>
    ...
    <div style="position:fixed; left:33%; top:48%; z-index:4; font-size:18px;"> нууц үг солигдсон </div>
...
<h2 style="color:#FFFFFF;"> Та өөрийн бүртэглээ устгахыг хүсч байна уу? </h2> </div>
